    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('motor.update', ['motor' => $motor]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            @enderror"
                                type="text" value="{{ $motor->name }}" name="name" placeholder="Masukkan Nama Motor">
                            @error('name')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                                <input type="text" value="{{ $motor->tahun }}" id="year" name="tahun"
                        ...
                        <div class="col-sm-10">
                            ...
                            @enderror">
                                @foreach ($jenis as $item)
                                    <option value="{{ old($item->id) ? 'selected' : '' }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
                            @error('JenisId')
                                <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            @enderror"
                                type="text" value="{{ $motor->transmisi }}" name="transmisi"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            @enderror"
                                type="text" value="{{ $motor->merkMotor }}" name="merkMotor"
                        ...
                        <div class="col-sm-2">
                            ...
                            @enderror"
                                type="date" value="{{ $motor->masaPajak }}" name="masaPajak"
                                placeholder="Masukkan Merk Motor">
                            @error('masaPajak')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            @enderror"
                                name="kilometer" value="{{ $motor->kilometer }}" placeholder="Masukkan Kilometer Motor">
                            @error('kilometer')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            @enderror" type="text"
                                name="deskripsi" placeholder="Masukkan Deskripsi Motor">{{ $motor->deskripsi }}</textarea>
                            @error('deskripsi')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            @enderror"
                                name="harga" value="{{ $motor->harga }}" placeholder="Masukkan Harga Motor">
                            @error('harga')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
