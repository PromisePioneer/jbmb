            ...
            <div class="card-body">
                <div class="mb-4">
                    <div class="float-start mini-stat-img me-4">
                        <img src="{{ asset('dashboard/images/services-icon/01.png') }}" alt="">
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    <div class="float-start mini-stat-img me-4">
                        <img src="{{ asset('dashboard/images/services-icon/02.png') }}" alt="">
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    <div class="float-start mini-stat-img me-4">
                        <img src="{{ asset('dashboard/images/services-icon/03.png') }}" alt="">
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body">
                <div class="mb-4">
                    <div class="float-start mini-stat-img me-4">
                        <img src="{{ asset('dashboard/images/services-icon/04.png') }}" alt="">
                    </div>
